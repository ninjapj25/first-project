...
const CampaignCreation = async(() =>
  import("../pages/tables/CampaignCreation")
);
const CSVExcelFileImport = async(() =>
  import("../pages/tables/CSVExcelFileImport")
);

const CrmLookAlike = async(() => import("../pages/tables/CrmLookAlike"));
...
const tablesRoutes = {
  ...
  children: [
    ...
    {
      path: "/tables/campagin-creation",
      name: "Campaign Creation",
      component: CampaignCreation,
    },
    {
      path: "/tables/csv-excel-file-import",
      name: "CSV Excel File Import",
      component: CSVExcelFileImport,
    },
    {
      path: "/tables/crm-lookalike",
      name: "CRM Lookalike",
      component: CrmLookAlike,
    },
  ],
  component: null,
};
